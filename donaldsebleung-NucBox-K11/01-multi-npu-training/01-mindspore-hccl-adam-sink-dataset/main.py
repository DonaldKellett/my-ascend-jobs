...
from mindspore.train import Callback, EarlyStopping, LossMonitor, Model

"""
01-mindspore-hccl-adam-sink-dataset.py
...
class MLflowLogging(Callback):
    ...
    def on_train_step_end(self, run_context):
        ...
        current_loss = outputs.asnumpy().mean()
...
def main():
    ...
    if rank_id == 0:
        ...
        fig.tight_layout()
        plt.savefig(
            '01-mindspore-hccl-adam-sink-dataset-fashion-mnist-samples.png',
            dpi=300,
            bbox_inches='tight',
            transparent=False,
            format='png'
    ...
    run_name = '01-mindspore-hccl-adam-sink-dataset'
    network_type = 'lenet'
